class sadFace extends PaintFunction{
    ...
    onDragging(coord){
        ...
        this.contextDraft.moveTo(this.origX - 0.7*radius, this.origY + 0.43*radius);
        this.contextDraft.arc(this.origX,this.origY + 0.43*radius,0.7*radius,Math.PI,2*Math.PI);
    ...
    onMouseUp(coord){
        ...
        this.contextReal.moveTo(this.origX - 0.7*radius, this.origY + 0.43*radius);
        this.contextReal.arc(this.origX,this.origY + 0.43*radius,0.7*radius,Math.PI,2*Math.PI);
