...
let layer = function () {
    ...
    $(".layerTitle").on("click", () => {
        ...
        this.canvasReal = document.getElementById(`canvas-${liLeng + 1}`);
        this.contextReal = this.canvasReal.getContext('2d');
        canvasArr.length = 0;
    ...
    $("ul").on("mousedown", function (e) {
        ...
        this.canvasReal = document.getElementById(`canvas-${e.target.id}`);
        this.contextReal = this.canvasReal.getContext('2d');
